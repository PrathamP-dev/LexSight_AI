  ...
  return (
    <>
      ...
      <div className="relative min-h-screen w-full overflow-hidden">
        ...
        <main className="container mx-auto flex min-h-screen flex-col items-center justify-center text-center">
          <motion.div
          ...
          <motion.div 
            ...
            className="mt-20 grid gap-8 sm:grid-cols-2 lg:grid-cols-4 z-10"
          >
